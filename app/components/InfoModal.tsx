  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <p className="text-xs text-gray-500 uppercase tracking-widest mb-1">About</p>
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-gray-700 px-4 py-2 text-sm text-emerald-400 hover:border-emerald-500 hover:text-emerald-300 transition-colors"
        >
