...
import { ETF_TICKERS_BY_CATEGORY, type ETFCategory } from "@/lib/etf-config";
...
export async function GET(req: NextRequest) {
  ...
  const results = await getTopPerformers(range as Parameters<typeof getTopPerformers>[0], tickers, {});
